...
final class AddEventViewModel {
    ...
    func tappedDone() {
        guard let name = nameCellViewModel?.title, let dateString = dateCellViewModel?.subtitle, let image = backgroundImageCellViewModel?.image, let date = dateFormatter.date(from: dateString) else { return }
