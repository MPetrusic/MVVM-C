...
//  EventsApp
//
//  Created by Milos Petrusic on 16.10.21..
//
...
final class TitleSubtitleCell: UITableViewCell {
    ...
    lazy var doneButton: UIBarButtonItem = { UIBarButtonItem(barButtonSystemItem: .done, target: self, action: #selector(doneTapped))
    }()
    ...
    private func setupViews() {
        ...
        photoImageView.backgroundColor = UIColor.black.withAlphaComponent(0.5)
